...
export function BusinessDashboardComponent() {
  ...
  const products =
    user.businesses?.flatMap((business) => business.products) || [];
          ...
          <Card key={product.id} className="flex flex-col">
            <CardHeader>
              <CardTitle className="flex justify-between items-center">
                ...
                <Badge className="text-white bg-black" variant="secondary">
            ...
            <CardContent className="flex-grow">
              ...
              <p className="text-sm text-gray-700 mb-2">
                ...
                {product.reviews?.[0]?.title || "No reviews yet"}&quot;
                <span className="text-gray-600 text-sm ml-2">
                  (
                  {product.reviews?.[0]?.createdDate
                    ? new Date(
                        product.reviews?.[0]?.createdDate,
                      ).toLocaleDateString()
                    : null}
