                ...
                <div className=" overflow-x-auto whitespace-nowrap ">
                    {categories.map((category, index) => (
                        <div className="inline-block mb-2" key={index}>
                            <div className=' text-2xl hover:text-3xl hover:bg-white dark:hover:bg-neutral-950 cursor-pointer  flex flex-col bg-transparent rounded justify-around items-center p-2 transition-all ease-in-out'>
                                {category.icon}
