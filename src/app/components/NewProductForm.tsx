...
const NewProductForm = (): JSX.Element => {
  ...
  return (
    <div className="p-6 shadow-md rounded-lg flex flex-col w-full sm:px-2 lg:w-1/2 items-center bg-myTheme-lightbg dark:bg-myTheme-dark ">
      <h2 className="text-2xl font-semibold mb-4">Create New Product</h2>
      <form
        onSubmit={handleSubmit}
        className="flex flex-col w-full h-full rounded-md bg-myTheme-lightbg dark:bg-myTheme-dark"
      >
        <div className="mb-4">
          <label className="block text-gray-600">Upload Image</label>
          <div className="relative border rounded border-gray-300 bg-myTheme-lightbg dark:bg-myTheme-niceGrey overflow-hidden flex items-center justify-center">
            <input
              type="file"
              name="display_image"
