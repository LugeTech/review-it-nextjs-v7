        ...
        <div className="flex items-center w-full sm:w-auto mb-2 sm:mb-0">
          {review?.user && (
            <Image
              ...
              width={40}
              height={40}
              className="rounded-full object-cover w-10 h-10 sm:w-12 sm:h-12 mr-3 sm:mr-0"
            />
          )}
        ...
        <div className="flex-grow w-full min-w-0">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between text-xs gap-2">
            ...
            <Link
              ...
              className="bg-blue-600 text-white hover:bg-blue-700 px-3 py-1 rounded transition-colors duration-200 w-full sm:w-auto text-center"
            >
              View review
            </Link>
          </div>
